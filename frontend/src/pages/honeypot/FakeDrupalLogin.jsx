...
const FakeDrupalLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setSuccess(false);
    try {
      const res = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:5000'}/drupal/user/login`, {
        method: 'POST',
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-md">
        <div className="flex flex-col items-center mb-6">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Drupal User Login</h1>
        </div>
        {success ? (
...
export default FakeDrupalLogin;